...
const mockInsightData: InsightData[] = [
  {
    ...
    researchSummary: '골드만삭스는 엔비디아의 목표주가를 $1,200로 상향 조정하며, AI 산업의 최대 수혜주로 평가했습니다. 모건스탠리는 투자의견 "비중 확대"를 유지하며, 소프트웨어 및 서비스 부문의 성장을 긍정적으로 전망했습니다.',
  ...
  },
  {
    ...
    researchSummary: 'JP모건은 애플의 서비스 부문 가치를 재평가하며 투자의견을 "매수"로 유지했습니다. 뱅크오브아메리카는 Vision Pro의 초기 판매량이 예상을 하회할 수 있다며 신중한 입장을 보였습니다.',
            ...
            <CardContent className="p-4">
              ...
              <Tabs defaultValue="news" className="w-full">
                <TabsList className="grid w-full grid-cols-4 h-auto">
                  ...
                  <TabsTrigger value="research" className="flex flex-col h-full items-center justify-center gap-1 p-2 text-[11px] leading-none">
                    {sourceIcons.research}
                    <span>리서치</span>
                  </TabsTrigger>
                ...
                <div className="mt-4 p-4 bg-muted rounded-md min-h-[120px]">
                  ...
                  <TabsContent value="research">
                    <p className="text-sm text-muted-foreground leading-relaxed">{item.researchSummary}</p>
                  </TabsContent>
